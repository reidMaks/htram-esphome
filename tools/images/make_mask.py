...
Two details this script exists to record, because both cost an attempt:
  ...
  * In Phase 3, Tryzub was moved to GD32 SPI flash as a cached asset, where
    blitting row-by-row on GD32 bypasses ESP32 LVGL DRAM draw buffers entirely,
    allowing the original full 150 px height (108x150) without OOM.
