...
| `clock` | `button_double` | 50 | `weather_open_btn` | Відкрити прогноз погоди за порами доби (`modal_weather`). |
...
### 2.5. Погодинний прогноз погоди за порами доби (`05_weather_forecast`)
...
- **Компонування**:
  ...
  - Три інтервали доби: **Ранок (09:00)**, **День (14:00)**, **Вечір (19:00)** (або найближчі години відповідно до часу доби).
...
### 2.8. Відбій повітряної тривоги (`08_alert_clear`)

![Відбій тривоги](screenshots/08_alert_clear.png)

- **Індикація на екрані**:
  - Після зняття небезпеки цифри годинника забарвлюються у заспокійливий зелений колір (`#3DD68C`) на 5 хвилин.
  - Статусна піктограма небезпеки автоматично зникає.
- **Звуковий супровід**: Мелодія відбою тривоги.

---

### 2.9. Діагностика: Ідентифікатор пристрою та IP-адреса (`09_device_id`)

![Ідентифікатор пристрою](screenshots/09_device_id.png)

- **Активація**: Потрійний клік кнопки на годиннику (`button_triple` у контексті `clock`) або кнопка «Show Device ID» в Home Assistant.
