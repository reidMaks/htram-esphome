...
Проєкт **HTRAM** еволюціонував від монолітної прошивки годинника воєнного часу до модульної системи із пакетами розширень (`features/alarm.yaml`, `features/weather.yaml`, `features/timer.yaml`, `features/debug.yaml`).
